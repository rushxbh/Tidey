...
export type { AquaCoin } from "./contracts/AquaCoin";
export { AquaCoin__factory } from "./factories/contracts/AquaCoin__factory";
export type { Tidey } from "./contracts/Tidey";
export { Tidey__factory } from "./factories/contracts/Tidey__factory";
